...
class AuthService:
    ...
    def __init__(self):
        ...
        self.ACCESS_TOKEN_EXPIRE_MINUTES = int(os.getenv("ACCESS_TOKEN_EXPIRE_MINUTES", str(self.DEFAULT_ACCESS_TOKEN_EXPIRE_MINUTES)))
        self.REFRESH_TOKEN_EXPIRE_MINUTES = int(os.getenv("REFRESH_TOKEN_EXPIRE_MINUTES", str(self.DEFAULT_REFRESH_TOKEN_EXPIRE_MINUTES)))
    ...
    def generate_tokens(self, user: User) -> Tuple[str, str]:
        ...
        """
        try:
            access_payload: Dict[str, Any] = self._build_claims(user, token_type="access", expires_minutes=self.ACCESS_TOKEN_EXPIRE_MINUTES)
            refresh_payload: Dict[str, Any] = self._build_claims(user, token_type="refresh", expires_minutes=self.REFRESH_TOKEN_EXPIRE_MINUTES)
